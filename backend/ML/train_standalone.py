...
def train_and_save():
    ...
    ae.fit(X_train, X_train, epochs=50, batch_size=32, validation_data=(X_val, X_val), verbose=0)
    ...
    lstm.fit(X_lstm, Y, epochs=50, batch_size=32, validation_split=0.2, verbose=0)
